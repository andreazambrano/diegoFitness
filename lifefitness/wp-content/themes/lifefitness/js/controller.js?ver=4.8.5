	...
	(function($){
		...
		$('.post-social-share').each(function(){
			...
			$this.find('span').on('click',function(){
				$this.find('a').toggleClass('animated');
			});
		});
...
/*======================*/
	...
	(function($){
		...
		/*-----------------------*/
			...
			$(".nz-content-box.version3").each(function(){

				var $this    = $(this),
					$col     = $this.data('columns'),
					$col1024 = ($col == 1) ? 1 : ($col > 4) ? 4 : $col,
					$auto    = $this.data('autoplay');
		...
		/*-----------------------*/
			...
			$(".nz-recent-posts.grid").each(function(){
				var $container = $(this);
				imagesLoaded( $container, function() {
					$container.masonry({
						itemSelector: '.post',
